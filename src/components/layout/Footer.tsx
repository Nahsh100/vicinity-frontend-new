        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-3 sm:space-x-4">
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-gray-800 hover:bg-primary-500 flex items-center justify-center transition-all"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link to="/help" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                  Help Center
                </Link>
              </li>
              <li>
                <Link to="/feedback" className="text-gray-400 hover:text-primary-400 transition-colors text-sm">
                  Send Feedback
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-6 sm:pt-8 border-t border-gray-800">
          <div className="text-center md:text-left">
            <p className="text-gray-400 text-xs sm:text-sm">
              &copy; 2024 vicinity. All rights reserved.
            </p>
          </div>
        </div>
      </div>
